...
func (_m *UserServiceInterface) CreateUser(c context.Context, user *model.User) error {
...
func (_m *UserServiceInterface) GetByEmail(c context.Context, email string) (model.User, error) {
...
func (_m *UserServiceInterface) GetByID(c context.Context, id string) (model.User, error) {
	ret := _m.Called(c, id)
